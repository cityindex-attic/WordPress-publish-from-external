	...
	tinymce.create('tinymce.plugins.PosteditormodalPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mcePosteditormodal', function() {				
				tb_show('', '/labs-team/wp-admin/admin-ajax.php?action=get_modal_editor&posteditormodal_action=excel_to_table&_wpnonce='+posteditor_modal_nonce+'TB_iframe=true');
			});
